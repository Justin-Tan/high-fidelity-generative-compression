...
1. An autoencoding architecture defining a nonlinear transform to latent space. This is used in place of linear transforms used by traditional image codecs.
...
The model is then trained end-to-end by optimization of the rate-distortion Lagrangian.
